...
Given an image, upscale the image by a factor of 2, 3 or 4 and return the upscaled image.
...
- endpoint: `/get/image/<token>.<extension>`
    ...
    - **NOTE**: the model is slow! on the hardware I've tested it on, it takes about 1 minute to process a 1Mpixel image; GPU acceleration makes it faster, but changes need to be implemented; the hardware I'm renting doesn't have GPUs
